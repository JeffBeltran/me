...
@section('content')
<div class="container mx-auto p-8 lg:w-3/4">
    <h1 class="text-green-500 text-4xl lg:text-6xl border-b border-green-700 mb-4">Jeff Beltran</h1>
    <ul class="text-xl lg:text-2xl text-gray-800 flex flex-col lg:flex-row">
        <li class="flex items-center hover:text-green-400 pb-2 lg:pr-6">
            <a href="https://github.com/JeffBeltran" class="flex items-center">
        ...
        <li class="flex items-center hover:text-green-400 pb-2 lg:pr-6">
            <a href="https://twitter.com/whereisjefe" class="flex items-center">
        ...
        <li class="flex items-center hover:text-green-400 pb-2 lg:pr-6">
            <a href="https://stackoverflow.com/users/270026/jeffbeltran" class="flex items-center">
        ...
        <li class="flex items-center cursor-not-allowed text-gray-600 hover:text-green-400 pb-2 lg:pr-6">
